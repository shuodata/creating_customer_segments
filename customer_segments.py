...
# Cluster assignment:
# 
# K-Means << SOFT / HARD >> assignment of points to cluster (assumes symmetrical spherical shapes)
# GMM << SOFT / HARD >> assignment gives more information such as probabilities (assumes elliptical shape)
